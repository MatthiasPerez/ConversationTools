...
namespace dialogtool
{
    class Program
    {
        ...
        private static void DisplayDialogToolSyntax()
        {
            ...
            Console.WriteLine();
            Console.WriteLine(@"dialogtool gensource input\savings_0703.xml");
            ...
            Console.WriteLine();
            Console.WriteLine(@"dialogtool compare input\savings_0703-v2.xml input\savings_0703-v1.xml input\questions.csv");
            Console.WriteLine(@">  compare answers and dialog behavior for 2 versions of dialog file");
